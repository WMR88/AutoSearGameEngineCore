...
public class ASGEImGui {
    ...
    public static void drawVec2Control(String label, Vector2f values, float resetValue, float columnWidth) {
        ...
        ImGui.pushStyleColor(ImGuiCol.ButtonActive, 1.0f, 0.0f, 0.0f, 1.0f);
        ...
        ImGui.pushStyleColor(ImGuiCol.ButtonHovered, 0.0f, 1.0f, 0.0f, 1.0f);
        ImGui.pushStyleColor(ImGuiCol.ButtonActive, 0.0f, 1.0f, 0.0f, 1.0f);
