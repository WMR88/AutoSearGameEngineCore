...
public class DebugDraw {
    ...
    // 6 floats per vert, 2 verts per line
    private static float[] vertexArray = new float[MAX_LINES * 6 * 2];
    private static Shader shader = AssetPool.getShader("EngineAssets/Shaders/debugLine2D.shader");
    ...
    public static void draw() {
        ...
        // draw the batch
        glDrawArrays(GL_LINES, 0, lines.size() * 6 * 2);  // uses bresenham's line algorithm?
    ...
    public static void addCircle(Vector2f center, float radius, Vector3f color, int lifetime) {
        Vector2f[] points = new Vector2f[20]; //// CIRCLES SEGMENTS
